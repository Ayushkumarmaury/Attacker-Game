window.addEventListener('load', function () {
        ...
        draw(context) {
            ...
            if (this.game.gameOver) {
                ...
                if (this.game.score > this.game.winningScore) {
                    message1 = 'You win the Game!!';
                    message2 = 'Well done! 👍';
                } else {
                    message1 = 'You lose the Game!!';
                    message2 = 'Try again !!'
                }
    ...
    class Game {
        ...
        update(deltaTime) {
            ...
            if (this.enemyTimer > this.enmeyInterval && !this.gameOver) {
                this.addEnemy();
                this.enemyTimer = 0;
            } else {
        ...
        addEnemy() {
            ...
            else if (randomise < 0.8) { this.enemies.push(new HiveWhale(this)); }
    ...
    function animate(timeStamp) {
        ...
        lastTime = timeStamp;
        ctx.clearRect(0, 0, canvas.width, canvas.height);//clear previous canva drawing
        game.draw(ctx);
